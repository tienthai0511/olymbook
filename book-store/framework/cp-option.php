<?php
	...
	*/
	...
	$crunchpress_menu = array(			
		...
		__('Translation', 'crunchpress') => array(
			__('Header', 'crunchpress')=>'cp_panel_translation',
			__('Cart', 'crunchpress')=>'cp_panel_translation_cart',
			__('Header Search', 'crunchpress')=>'cp_panel_translation_search',
			__('Products Details', 'crunchpress')=>'cp_panel_translation_products',
			__('Products Slider', 'crunchpress')=>'cp_panel_translation_product_slider'),
	...
	$crunchpress_element = array(
		...
		'cp_panel_translation' => array(
		     __('Welcome!', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_welcome',
			 	'default'=>'Welcome!'),	
		     __('Create an Account', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_create_an_account',
				'default'=>'Create an Account'),	
		     __('Log In', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_login',
				'default'=>'Log In'),
			 __('Log Out', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_logout',
				'default'=>'Log Out'),
			 __('Register', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_register',
				'default'=>'Register'),
			 __('My Account', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_myaccount',
				'default'=>'My Account'),	
			 __('View Order', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_view_order',
				'default'=>'View Order'),	
		  	 __('Cart', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_cart',
				'default'=>'Cart'),
			 __('Checkout', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_checkout',
				'default'=>'Checkout'),	
		),
		
		'cp_panel_translation_cart' => array(
		     __('Item', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_cart_item',
			 	'default'=>'item'),	
			  __('No products in the cart', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_cart_no_product',
			 	'default'=>'No products in the cart.'),		
		     __('Checkout', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_cart_checkout',
				'default'=>'Checkout'),	
		     __('View Cart', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_cart_viewcart',
				'default'=>'View Cart'),
		),
		
		'cp_panel_translation_products' => array(
		     __('Book Detail', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_book_details',
			 	'default'=>'Book Detail'),	
		),
		
		'cp_panel_translation_product_slider' => array(
		     __('by', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_slider_by',
			 	'default'=>'by'),
			 __('Read More', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_slider_readmore',
			 	'default'=>'Read More'),	
		),
		
		
		'cp_panel_translation_search' => array(
		     __('Search for products', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_search_product',
			 	'default'=>'Search for products'),	
			  __('Search', 'crunchpress')=>array('type'=>'inputtext','name'=>THEME_NAME_S.'_translation_search_button',
			 	'default'=>'Search'),		
		),
