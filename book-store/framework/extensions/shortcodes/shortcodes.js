           ...
           ed.addButton('button-shortcodes', {
			...
			ed.addButton('testmo-shortcodes', {
				...
				onclick : function() {
					...
					window.tinyMCE.execCommand('mceInsertContent', false, '[testimonial title="TESTIMONIAL TITLE WILL GO HERE"]');
			...
			ed.addButton('divider-shortcodes', {
				...
				onclick : function() {
					...
					window.tinyMCE.execCommand('mceInsertContent', false, '[divider scroll_text="SCROLL TEXT"]');
			...
			ed.addButton('price-shortcodes', {
				...
				onclick : function() {
					...
					window.tinyMCE.execCommand('mceInsertContent', false, '[price-item item_number="6" category="PRICE TABLE CATEGORY"]');
			...
			ed.addButton('space-shortcodes', {
				...
				onclick : function() {
					...
					window.tinyMCE.execCommand('mceInsertContent', false, '[space height="HEIGHT"]');
			...
			ed.addButton('audio-shortcodes', {
				...
				onclick : function() {
					...
					window.tinyMCE.execCommand('mceInsertContent', false, '[audio:INSERT YOUR MP3 AUDIO FILE LINK HERE]');
			...
			ed.addButton('lightbox-shortcodes', {
				...
				onclick : function() {
					...
					window.tinyMCE.execCommand('mceInsertContent', false, '[frame src="INSERT YOUR PHOTO URL HERE" width="290" height="200" 		lightbox="on" ]');
			...
			ed.addButton('tab-shortcodes', {
					...
					onclick : function() {
						...
						window.tinyMCE.execCommand('mceInsertContent', false, '[tab]<br>[tab_item title="ITEM_TITLE"]ADD_CONTENT_HERE[/tab_item]<br>[tab_item title="ITEM_TITLE"]ADD_CONTENT_HERE[/tab_item]<br>[tab_item title="ITEM_TITLE"]ADD_CONTENT_HERE[/tab_item]<br>[/tab]<br /> <br /> ');
			...
			ed.addButton('accordion-shortcodes', {
					...
					onclick : function() {
						...
						window.tinyMCE.execCommand('mceInsertContent', false, '[accordion]<br>[acc_item title="ITEM_TITLE"]ADD_CONTENT_HERE[/acc_item]<br>[acc_item title="ITEM_TITLE"]ADD_CONTENT_HERE[/acc_item]<br>[acc_item title="ITEM_TITLE"]ADD_CONTENT_HERE[/acc_item]<br>[/accordion]<br /><br /> ');
