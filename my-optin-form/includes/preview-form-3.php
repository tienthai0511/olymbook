	...
	<div id="optinforms-form3">
		<div id="optinforms-form3-inside" style="background: #FFFFFF;">
			<div id="optinforms-form3-container-left">
				<div id="optinforms-form3-title" style="font-family:Droid Serif; font-size:26px; line-height:28px; color:#505050; "><?php echo $shortDescription; ?></div><!--optinforms-form3-title-->
				<div id="optinforms-form3-subtitle" style="font-family:Arial; font-size:16px; color:#000000; "><?php echo $description ?></div><!--optinforms-form3-subtitle-->
