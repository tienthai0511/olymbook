<?php
	...
	*/
	...
	function print_blog_item($item_xml){
		...
		global $paged;
		global $sidebar;
		global $blog_div_size_num_class, $item_type, $item_class, $item_index;
	...
	function print_blog_full( $item_class, $item_size, $item_index, $num_excerpt, $full_content ){
	...
	function print_blog_posts($item_xml){
		...
		if(empty($paged)){
          ...
          ?>
            ...
            <div class="post-det">
              <h3 class="title-holder"><?php echo '<a href="' . get_permalink() . '">' . $product_title . '</a>'; ?></h3>
