...

{
    ...
    $translation_welcome = get_option(THEME_NAME_S.'_translation_welcome','Welcome!');
	$translation_create_an_account = get_option(THEME_NAME_S.'_translation_create_an_account','Create an Account');
	$translation_login = get_option(THEME_NAME_S.'_translation_login','Log In');
	$translation_logout = get_option(THEME_NAME_S.'_translation_logout','Log Out');
	$translation_register = get_option(THEME_NAME_S.'_translation_register','Register');
	$translation_myaccount = get_option(THEME_NAME_S.'_translation_myaccount','My Account');
	$translation_view_order = get_option(THEME_NAME_S.'_translation_view_order','View Order');
	$translation_cart = get_option(THEME_NAME_S.'_translation_cart','Cart');
	$translation_checkout = get_option(THEME_NAME_S.'_translation_checkout','Checkout');
	...
	{
		$output .= "<li><a class='account_overview_link' title='Account' href='".$url['account_overview']."'>".$translation_myaccount."</a></li> ";
		...
		/*$output .= "<li class='account_change_pw_link'><a href='".$url['account_change_pw']."'>".__('Change Password', 'cp_framework')."</a></li>";*/
			...
			$output .= "<li><a class='account_view_order_link'  title='Order' href='".$url['account_view_order']."'>".$translation_view_order."</a></li>";
	}else
	{
		if(get_option('users_can_register')) 
		{
			$output .= "<li><a class='register_link' title='Register' href='".$url['register']."'>".$translation_register."</a></li> ";
		}
		$output .= "<li><a class='account_login_link' title='Log In' href='".$url['account_overview']."'>".$translation_login."</a></li>";
	}

	$output .= "<li><a class='shopping_cart_link' title='Cart' href='".$url['cart']."'>".$translation_cart."</a></li>";
	$output .= "<li><a class='checkout_link' title='Checkout' href='".$url['checkout']."'>".$translation_checkout."</a></li>";
	$output .= "</ul>";
...

{
	...
	{   
	  global $current_user;
        get_currentuserinfo();
       echo '<li>' .get_option(THEME_NAME_S.'_translation_welcome ','Welcome! '). ' <a>' . $current_user->display_name . "\n</a></li>";
		/*echo  "<li><a title='Account' href='".$url['account_overview']."'>".__('My Account ', 'cp_framework')."</a></li>";*/
	       echo "<li ><a title='logout' href='".$url['logout']."'>".$translation_logout."</a></li>";
		/*$output .= "<li class='account_change_pw_link'><a href='".$url['account_change_pw']."'>".__('Change Password', 'cp_framework')."</a></li>";*/
			/*$output .= "<li class='account_edit_adress_link'><a href='".$url['account_edit_adress']."'>".__('Edit Address', 'cp_framework')."</a></li>";*/
	...
	
	{
		...
		echo '<li>' .$translation_welcome. '</li>';
	  echo "<li><a title='Log In' href='".$url['account_overview']."'>".$translation_login."</a></li>";
	  
	  if(get_option('users_can_register')) 
		{
			echo "<li>or <a title='Register' href='".$url['register']."'>".$translation_create_an_account."</a></li> ";
		}
	}
