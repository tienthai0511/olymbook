		...
		<div style="clear:both"></div>
		<div class="span12 witdh-1075 opt-in-content" style="background:#404042">
		<div style="margin:0 auto">
			...
			?>
				...
				<ul class="ul-opt-in">
					<li>
						<p class="title-opt-in">Chỉ cần đăng kí email bạn sẽ nhận</p>
						<p class="title-opt-in">đươc Ebook này NGAY LẬP TỨC</p>
					</li>
					<li><input type="text" name="email" id="email" class="infusion-field-input-container"></li>
